...
//     if (address.trim() === '' || email.trim() === '') {
//       toast.success('Please enter your delivery address and email.');
//       return;
//     }
//     if (paymentMethod === 'COD') {
//       // Directly handle COD payment
      ...
      const options = {
        ...
        handler: async (response) => {
          ...
          if (razorpay_payment_id && razorpay_order_id && razorpay_signature) {
            ...
            try {
              const verificationResponse = await fetch('http://localhost:5000/api/v1/pay/paymentverification', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({
                  razorpay_order_id,
